...
<form:form method="post" action="/api/item/edit/${item.id}" modelAttribute="item">
    ...
    <p>Nazwa: <form:input id="name" path="name" value="${name}"/></p>

    <p>Opis: <form:input id="description" path="description" value="${desription}"/></p>
    <p>Ilość: <form:input id="quantity" path="quantity" value="${quantity}"/></p>
